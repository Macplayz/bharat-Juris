...
export default function DocumentAnalyzerPage() {
  ...
  // Helper to show correct icon based on file type
              ...
              <div className="space-y-8 animate-in fade-in zoom-in-95 duration-500">
                <div className="text-center space-y-4">
                  ...
                  <p className="text-gray-400 text-lg max-w-xl mx-auto leading-relaxed">
                    Upload a <strong>PDF or Screenshot</strong> of any legal notice. Our AI vision system will extract key dates and actions instantly.
                  </p>
                </div>
                ...
                >
                   ...
                   <p className="text-sm text-gray-500 mt-2">PDF, JPG, PNG (Max 4MB)</p>
                </div>
                 ...
                 <div className="bg-[#111] border border-[#333] p-8 rounded-3xl text-center space-y-6 shadow-2xl">
                    ...
                    <div className="flex gap-4 pt-4">
                      ...
                      <Button onClick={handleStartAnalysis} disabled={isAnalyzing} className="flex-1 bg-blue-600 hover:bg-blue-500 text-white font-semibold py-6 rounded-xl flex items-center justify-center gap-2">
                        {isAnalyzing ? <><Activity className="w-5 h-5 animate-spin" /> Scanning...</> : <><Play className="w-5 h-5 fill-current" /> Analyze {isPDF ? 'PDF' : 'Image'}</>}
                      </Button>
                    </div>
                 </div>
              </div>
